...
func _on_player_detect_area_3d_player_entered(player : SPPlayer3D) -> void:
	...
	coin_sfx_data.pitch_scale = 1.5
	coin_sfx_data.volume_db = -8.0
	coin_sfx_data.max_db = -3.0
	coin_sfx_data.sound_start = 0.18
	Utils.play_3d_sound_at(load("res://art/sfx/collectibles/chiclin.mp3"), global_transform.origin, get_parent(), coin_sfx_data)
